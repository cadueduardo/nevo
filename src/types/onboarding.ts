export type OnboardingStep =
  | 'welcome'
  | 'welcome_intro_choice'
  | 'welcome_tutorial_cta'
  | 'restart_confirm'
  | 'domain_detection'
  | 'domain_confirmation'
  | 'business_type'
  ...
  | 'quote_variables'
  | 'branding_offer'
  | 'branding_company_legal_name'
  | 'branding_cnpj'
  | 'branding_company_phone'
  | 'branding_company_email'
  | 'policies'
  | 'tone_of_voice'
  | 'handoff_mode'
  | 'target_audience'
  ...
  | 'services_edit'
  | 'sequence_booking_offer'
  | 'sequence_services_select'
  | 'signup_request'
  | 'signup_email'
  | 'signup_password'
